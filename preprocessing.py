...
'''
def build_dictionary(infile, stem=False, negate=True, pos=[], partial=False, num=500):
    if stem:
...
def write_features(infile):
    ...
    f.close()
    print "Done features"
    print ("restaurants bigger than 4 stars: " + one)
    print ("restaurants less than 4 stars:" + zero)
